const Header = ({ totalPrice, cartItemsCount }) => {
  return (
    <header className="flex justify-between items-center py-4 px-6 border-b-2 border-orange-500">
      ...
      <div className="flex items-center gap-6">
        ...
        <button className="flex items-center gap-2 bg-white border-2 border-orange-500 text-orange-500 px-5 py-2 rounded-full font-semibold hover:bg-orange-50 transition-colors">
